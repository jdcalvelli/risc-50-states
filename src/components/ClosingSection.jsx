...
function ClosingSection(props) {
    return(
        <div className="closingSection">
            ...
            Get in touch with us directly at <br/> <a href="mailto:aprilfeng@uchicago.edu?subject=50 State Snapshot Feedback">aprilfeng@uchicago.edu</a> or <a href="mailto:jdcalvelli@uchicago.edu?subject=50 State Snapshot Feedback">jdcalvelli@uchicago.edu</a>.</p>
